...
class _ArtState extends State<Art> {
  ...
  getTrendingWallpaper()async{
    var response =await http.get("https://api.pexels.com/v1/search?query=mobile+wallpaper+art&per_page=80&page=2",
        headers: {
      ...
      child: Scaffold(
        body: Container(
          ...
          child:Column(
            children: <Widget>[
              SizedBox(height: 20,),
              Text("Art",style: GoogleFonts.lalezar(fontSize: 50,color: Colors.white),),
              SizedBox(height: 20,),
              Container(

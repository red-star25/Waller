...
class _CodingState extends State<Coding> {
  ...
  getTrendingWallpaper()async{
    var response =await http.get("https://api.pexels.com/v1/search?query=coding&per_page=80&page=1",
        headers: {
      ...
      child: Scaffold(
        body: Container(
            ...
            child:Column(
              children: <Widget>[
                SizedBox(height: 20,),
                Text("Coding",style: GoogleFonts.lalezar(fontSize: 50,color: Colors.white),),

...
class _MoviesState extends State<Movies> {
  ...
  getTrendingWallpaper()async{
    var response =await http.get("https://api.pexels.com/v1/search?query=movie&per_page=80&page=1",
        headers: {
      ...
      child: Scaffold(
        body: Container(
            ...
            child:Column(
              children: <Widget>[
                SizedBox(height: 20,),
                Text("Movies",style: GoogleFonts.lalezar(fontSize: 50,color: Colors.white),),
